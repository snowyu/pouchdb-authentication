...
var urlJoin = _interopDefault(require(36));
var urlParse = _interopDefault(require(37));
var inherits = _interopDefault(require(30));
var pouchdbBinaryUtils = require(32);
var Axios = _interopDefault(require(2));
...
function signUpAdmin(username, password, opts) {
  ...
  if (['http', 'https'].indexOf(db.type()) === -1) {
    return Promise.reject(new AuthError('This plugin only works for the http/https adapter. ' + 'So you should use new PouchDB("http://mysite.com:5984/mydb") instead.'));
  } else if (!username) {
  ...
  return db.getMembership(opts).catch(function (error) {
...
function changeUsername(oldUsername, newUsername, opts) {
  ...
  return db.getUser(newUsername, opts).then(function () {
...
},{"2":2,"28":28,"30":30,"32":32,"36":36,"37":37}],2:[function(require,module,exports){
...
}).call(this,require(33))
},{"10":10,"13":13,"17":17,"18":18,"20":20,"22":22,"24":24,"26":26,"33":33}],4:[function(require,module,exports){
'use strict';
...
},{"11":11,"15":15,"26":26,"9":9}],9:[function(require,module,exports){
'use strict';
...
},{"14":14,"15":15,"19":19,"21":21,"26":26,"7":7}],12:[function(require,module,exports){
'use strict';
...
},{"23":23,"26":26,"3":3,"33":33}],16:[function(require,module,exports){
'use strict';
...
},{"16":16,"31":31}],27:[function(require,module,exports){
'use strict'
